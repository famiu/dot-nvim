    ...
    },
    {
        ...
        opts = {
            ...
            on_attach = function(bufnr)
                ...
                map('x', '<leader>hs', function() gs.stage_hunk({ vim.fn.line('.'), vim.fn.line('x') }) end)
                map('x', '<leader>hr', function() gs.reset_hunk({ vim.fn.line('.'), vim.fn.line('x') }) end)
                map('n', '<leader>hu', gs.undo_stage_hunk)
                map('n', '<leader>hS', gs.stage_buffer)
                map('n', '<leader>hR', gs.reset_buffer)
                map('n', '<leader>hp', gs.preview_hunk)
                map('n', '<leader>hd', function() gs.diffthis('', { split = 'botright' }) end)
                map('n', '<leader>hD', function() gs.diffthis('~', { split = 'botright' }) end)
